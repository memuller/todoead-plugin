<?php
	...
	class Zones extends CustomTaxonomy {

		static $name = "zones" ;
		static $applies_to = 'store';
		static $settings = array( 'hierarchical' => true,'show_ui' => true,'query_var' => true,'rewrite' => array('slug' => ''));
		static $labels = array(
			'name' => 'Áreas',
			'singular_name' => 'Área',
		...
		static $fields = array(
			'location' => array('type' => 'geo', 'label' => 'Localização', 'width' => '500px', 'height' => '300px',
				'default' => array('lat' => '-15.7801482', 'lng' => '-47.92916980000001'), 'description' => 'Ponto central da zona.
